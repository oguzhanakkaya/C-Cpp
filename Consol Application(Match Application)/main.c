// #330103 #Oğuzhan Akkaya #oguzhanakkayaaa@gmail.com   #Struct Kullanımı
// #348284 #Reşat Karakaya #resatkrky_@hotmail.com      #Dosyalama İşlemleri
...
void puantablosuyazdirma(struct takim c[])
{
    ...
    for(int z=0;z<t.takimsayisi;z++)
    {
        for(int f=0;f<t.takimsayisi;f++)
        {
            if(c[z].puan>c[f].puan)
            {
